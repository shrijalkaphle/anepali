...
export const FilterComponent = ({ enableVoiceInput, isListening, previewText, originalText, previewTextChange, fontSize, setFontSize, minimumStyles, setMinimumStyles, hasRecongnitionSupport }: IFilterComponent) => {
