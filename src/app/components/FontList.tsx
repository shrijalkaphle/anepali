            ...
            <div className="w-full p-4 border-b border-neutral-200 hover:bg-neutral-100 hover:rounded-lg font-list" onMouseEnter={updateStyles} onMouseLeave={updateStyles}>
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-x-2 w-2/3">
                        ...
                        <span className="lg:text-sm text-xs whitespace-nowrap text-neutral-800">{styles} styles</span>
                        <span className="dot"> &middot; </span>
                        <span className="lg:text-sm text-xs whitespace-nowrap truncate text-neutral-800">{designer}</span>
                    </div>

                    <button className="bg-white border border-neutral-200 text-neutral-800 px-3 py-1.5 rounded-lg items-center gap-x-2 flex lg:text-sm text-xs w-[108px] hover:border-neutral-400" onClick={downloadFont}>
