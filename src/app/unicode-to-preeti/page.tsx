...
export default function UnicodeToPreetiPage() {
    ...
    return (
        <DefaultLayout>
            <div>
                <div className="mt-4">
                    <span className="font-semibold text-[40px] leading-[48px]">Unicode to Preeti <span className="text-primary-600">Converter</span></span>
                ...
                <div className="my-[60px] flex gap-x-2">
                    <div className="flex-grow">
                        ...
                        {/* text area */}
                        <div className="w-full border rounded-lg border-neutral-200 h-[480px] mt-6">
                            <textarea name="" id="" className="w-full h-[395px] resize-none outline-none p-5" placeholder="बुटवलको गल्लीहरूमा एउटा चालकबिहीन ट्याक्सी दौडिरहेको छ।" value={unicodeText} onChange={(e) => setUnicodeText(e.target.value)}></textarea>
                            <div className="p-4">
                    ...
                    <div className="flex-grow">
                        ...
                        <div className="p-4">
                                <button className="text-sm px-3 py-2 rounded-[55px] bg-white font-medium flex items-center gap-x-1" onClick={() => navigator.clipboard.writeText(preetiText)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        <path d="M15.2723 6.07227H8.56931C7.68332 6.07227 6.96509 6.79532 6.96509 7.68727V16.094C6.96509 16.9859 7.68332 17.709 8.56931 17.709H15.2723C16.1582 17.709 16.8765 16.9859 16.8765 16.094V7.68727C16.8765 6.79532 16.1582 6.07227 15.2723 6.07227Z" stroke="#404040" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M13.035 6.07098V3.90602C13.035 3.47769 12.866 3.06691 12.565 2.76404C12.2642 2.46117 11.8562 2.29102 11.4307 2.29102H4.72774C4.30228 2.29102 3.89424 2.46117 3.59339 2.76404C3.29255 3.06691 3.12354 3.47769 3.12354 3.90602V12.3128C3.12354 12.7411 3.29255 13.1518 3.59339 13.4547C3.89424 13.7576 4.30228 13.9278 4.72774 13.9278H6.96496" stroke="#404040" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
